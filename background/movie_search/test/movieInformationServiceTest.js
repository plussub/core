...
describe('MovieInformationService', () => {
    ...
    it('should map search results to information queries', function (done) {
        ...
        Object.keys(DEFAULT_MORE_RESULTS).map((k) => Object.assign({key:k,value:DEFAULT_MORE_RESULTS[k]})).forEach((e) => {
    ...
    it('should use imdb result as fallback', function (done) {
        ...
        SERVICE_CHANNEL.publish({
            topic: root.srtPlayer.Descriptor.SERVICE.MOVIE_INFORMATION.SUB.SEARCH,
            data: imdbIdWithoutMoreInformation
        });
    });
