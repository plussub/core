...
//expected results
const IMDB_RESULT = require('./expectedResponse.js').IMDB_RESULT;
const EXTENDED_IMDB_RESULTS = require('./expectedResponse.js').EXTENDED_IMDB_RESULTS;
...
describe('MovieSearchService', () => {
    ...
    const SEARCH_URL = "https://app.plus-sub.com/movie/search/";
    const INFORMATION_URL = "https://app.plus-sub.com/movie/information/";
    ...
    it('should use imdb result as fallback', function (done) {
        ...
        const imdbIdWithoutMoreInformation = 'ttWithoutMoreInformation';
