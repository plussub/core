...
srtPlayer.MovieInformationService = srtPlayer.MovieInformationService || ((messageBusLocal = messageBus, fetch = window.fetch) => {
        ...
        const SERVICE_CONST = srtPlayer.Descriptor.SERVICE.MOVIE_INFORMATION;
        ...
        async function loadData(query) {
            ...
            try {
                ...
                const results = await getMoreInformationFor(createImbdInformationFrom(await response.json()));
