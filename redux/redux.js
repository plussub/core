...
srtPlayer.Redux = srtPlayer.Redux || (() => {
    ...
    if (typeof localStorage === 'undefined') {
        ...
        persistedState = localStorage.getItem('reduxState') ? JSON.parse(localStorage.getItem('reduxState')) : initialState;
    }

    if (persistedState.debug.reduxStore) {
        console.log(`load persistence state: ${persistedState}`);
    }
